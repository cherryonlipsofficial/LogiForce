...
const schemas = {
  ...
  Client: require('../modules/billing/Client').schema,
  Supplier: require('../modules/billing/Supplier').schema,
  Vehicle: require('../modules/fleet/Vehicle').schema,
  VehicleAssignment: require('../modules/fleet/VehicleAssignment').schema,
  Project: require('../modules/billing/Project').schema,
  ProjectContract: require('../modules/billing/ProjectContract').schema,
  ...
  Invoice: require('../modules/billing/Invoice').schema,
  CreditNote: require('../modules/billing/CreditNote').schema,
  Advance: require('../modules/payroll/Advance').schema,
  DriverAdvance: require('../modules/payroll/DriverAdvance').schema,
